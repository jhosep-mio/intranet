...
const EditarEgresos = () => {
    ...
    const updateClinica = async () => {
        ...
        try {
            let respuesta= await axios.post(`${Global.url}/upadateEgreso/${id}`, data,{
                headers:{
            ...
            <div className="card">
                ...
                <form className="p-4 needs-validation" onSubmit={preguntar}>
                        ...
                        <div className="mb-3 col-md-11">
                            <div className='content_general mb-3 col-md-12'>
                                <div className="mb-3 col-md-12 div_conten">
                                    ...
                                    <textarea name="" id="" cols="0" rows="1" className="form-control3" autoFocus required style={{width: '100%'}}
                                    value={descripcion}
                                    type="text"
                    ...
                    <div className="d-flex gap-2 contentBtnRegistrar">
                            ...
                            <Link to="/admin/egresos" className="btn btn-danger btnCancelar">Cancelar</Link>
