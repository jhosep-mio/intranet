...
export const PacientesClinicas = () => {
  ...
  const getAllClinicas = async () => {
    ...
    const request = await axios.get(`${Global.url}/reporteClinicasPrimerMes`, {
      headers: {
    ...
    if (fechaInicio && fechaFin) {
      ...
      try {
        const oneOrden = await axios.post(
          `${Global.url}/reporteClinicasFechas`,
          data,
          {
            headers: {
              Authorization: `Bearer ${token}`,
      ...
      const request = await axios.get(`${Global.url}/reporteClinicas`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
            ...
            >
              <div className="content_excel">
                ...
                <ReactHTMLTableToExcel
                  ...
                  className="download"
                  table="productos2"
                  filename="Reporte_pacientes_enviados_por_clinicas"
                  sheet="sheet1"
                  buttonText="Excel"
                />
              </div>
