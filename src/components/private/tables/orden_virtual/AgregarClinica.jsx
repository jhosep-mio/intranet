...
const AgregarClinica = ({cerrar, setClinica, setNombreClinica}) => {
  ...
  const saveClinica = async (e) => {
    ...
    try {
      ...
      if (respuesta.data.status == "success") {
        ...
        setClinica(respuesta.data.res)
        setNombreClinica(respuesta.data.res_nombre)
        cerrar()
      } else {
      ...
      if (
        ...
        error.request.response.includes("The celular must") ||
        error.request.response.includes("The celular format is invalid")
      ) {
