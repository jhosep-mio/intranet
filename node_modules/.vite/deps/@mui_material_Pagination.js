...
} from "./chunk-UQ6XMA3C.js";
import "./chunk-6C7ITYGU.js";
import "./chunk-7WDIDY5O.js";
import {
  createPopper
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React60.useState(false);
...
var _excluded25 = ["center", "classes", "className"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var TouchRipple = React61.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const nextKey = React61.useRef(0);
  const rippleCallback = React61.useRef(null);
  React61.useEffect(() => {
  ...
  const ignoringMouseDown = React61.useRef(false);
  const startTimer = React61.useRef(null);
  const startTimerCommit = React61.useRef(null);
  const container = React61.useRef(null);
  React61.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React61.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start = React61.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React61.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React61.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
...
var ButtonBase = React62.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React62.useRef(null);
  ...
  const keydownRef = React62.useRef(false);
...
var SvgIcon = React63.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSvgIcon"
  });
...
function createSvgIcon(path, displayName) {
  ...
  return React64.memo(React64.forwardRef(Component));
}
...
var PaginationItem = React69.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime53.jsx)(PaginationItemEllipsis, {
    ...
    children: [type === "page" && page, Icon ? (0, import_jsx_runtime53.jsx)(PaginationItemPageIcon, {
      as: Icon,
      ownerState,
